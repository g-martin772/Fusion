...
#define FE_ASSERT(x) { if(!(x)) {FE_ERROR("Assertion Failed"); __debugbreak();}}
#define FF_ASSERT(x) { if(!(x)) {FF_ERROR("Assertion Failed"); __debugbreak();}}
#define FG_ASSERT(x) { if(!(x)) {FG_ERROR("Assertion Failed"); __debugbreak();}}
